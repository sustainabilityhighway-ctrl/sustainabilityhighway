...
async function getBlog(slug: string) {
    ...
    try {
        ...
        // If slug is numeric, check both slug and id. Otherwise, only check slug.
        // This prevents Postgres errors when comparing a string slug with an integer ID column.
        if (/^\d+$/.test(slug)) {
