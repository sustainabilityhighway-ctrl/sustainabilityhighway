    ...
    <section id="projects" className="py-24 px-6 bg-[#041612]">
      <div className="max-w-7xl mx-auto">
        <div className="mb-16">
          ...
          <p className="text-white/40 max-w-xl text-lg">Leading the world by example. Tracking the benchmarks of modern engineering that define the national commitment to nature.</p>
        </div>
